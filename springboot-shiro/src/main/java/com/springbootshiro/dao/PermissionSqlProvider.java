...
import com.springbootshiro.domain.PermissionExample.Criteria;
import com.springbootshiro.domain.PermissionExample.Criterion;
...
public class PermissionSqlProvider {
    ...
    public String insertSelective(Permission record) {
        ...
        if (record.getResType() != null) {
            sql.VALUES("res_type", "#{resType,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getResName() != null) {
            sql.SET("res_name = #{record.resName,jdbcType=VARCHAR}");
        }
        
        if (record.getResType() != null) {
            sql.SET("res_type = #{record.resType,jdbcType=VARCHAR}");
        }
